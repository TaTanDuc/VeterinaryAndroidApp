class Shop {
  ...
  factory Shop.fromJson(Map<String, dynamic> json) {
    return Shop(
      ...
      itemIMAGE: json['itemIMAGE'] ?? '', // Default image
  ...
  @override
  String toString() {
    return 'Shop(itemID: $itemID, itemName: $itemName, itemIMAGE:$itemIMAGE, categoryName: $categoryName, itemRating: $itemRating, price, $price, total: $total)';
  }
}
