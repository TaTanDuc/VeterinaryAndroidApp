...
import 'package:application/bodyToCallAPI/AdminPurchaseManagement.dart'
    as detail;
import 'package:application/bodyToCallAPI/SessionManager.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class AdminPurchaseDetailScreen extends StatefulWidget {
  final int orderId;
  final bool initialDarkMode;

  const AdminPurchaseDetailScreen({
    super.key,
  ...
  @override
  State<AdminPurchaseDetailScreen> createState() =>
      _AdminPurchaseDetailScreenState();
}

class _AdminPurchaseDetailScreenState extends State<AdminPurchaseDetailScreen> {
  bool _darkMode = false;
  bool _loading = true;
  String? _errorMessage;
  detail.AdminPurchaseManagement? _response;
  List<detail.PurchaseDetail> _orderDetails = [];
  ...
  Future<void> _fetchOrderDetails() async {
    ...
    try {
      ...
      final uri = Uri.parse(
          'http://10.0.2.2:8080/api/admin/invoices/purchase-details?invoiceID=${widget.orderId}');
      ...
      if (response.statusCode == 200) {
        ...
        final parsed = detail.AdminPurchaseManagement.fromJson(data);
