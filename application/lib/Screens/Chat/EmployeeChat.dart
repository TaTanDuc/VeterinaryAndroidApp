...
import 'package:application/Screens/Chat/WebsocketEmployee.dart';
...
class EmployeeChatScreen extends StatefulWidget {
  final int userID;
  const EmployeeChatScreen({super.key,required this.userID});
  @override
  _UserChatScreenState createState() => _UserChatScreenState();
}

class _UserChatScreenState extends State<EmployeeChatScreen> {
  ...
  void initState() {
    ...
    WebSocketEmployee().onMessageReceived = (Map<String, String> newMessage) {
      setState(() {
  ...
  void _deleteChat() async {
    ...
    setState(() {
      messages.clear();
      isConnected = false;
      WebSocketEmployee().reconnect(session!, widget.userID, isConnected);
    });
    try {
  ...
  Future<void> _initializeChat() async {
    ...
    WebSocketEmployee().onConnectCallback = (frame) {
      setState(() {});
    };

    WebSocketEmployee().initialize(session!,widget.userID);
  ...
  void _sendMessage(String message) {
    if (message.isNotEmpty) {
      ...
      WebSocketEmployee().sendMessage(widget.userID,userName!, message);
      setState(() {
        messages.add(
